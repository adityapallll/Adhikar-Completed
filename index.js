...
app.post('/login', function (req, res) {
	...
	if (username == "aakarsh" && password == "password") {
...
app.get('/info', function (req, res) {
	...
	if (cookie_pass == null || cookie_pass == '' || cookie_otp == null || cookie_otp == '') {
		...
		deployedContract = VotingContract.new(['Aakarsh', 'Aditiya', 'Ashish', 'Tushar'], { data: byteCode, from: web3.eth.accounts[0], gas: 4700000 })
